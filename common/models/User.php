...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public static $statusText = [
        ...
        self::STATUS_ADMIN_ONLY => 'Admin Only',
    ];
    ...
    {
        return $this->status == self::STATUS_ADMIN_ONLY;
    }
    ...
    public static function getBoardUsers()
    {
        ...
        return self::find()
            ->where("CONCAT(',',REPLACE(board_id,' ',''),',') LIKE " . "\"%," . Board::getCurrentActiveBoard()->id . ",%\"")
