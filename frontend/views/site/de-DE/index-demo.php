...
<div class="site-index">
    ...
    <div class="jumbotron">
        ...
        <p>
            <strong>Ban-The-Can</strong> is a Webproject that can be used for management of agenda topics (tickets).
            It contains a <strong>Backlog</strong> for collection topics, a <strong>Board</strong> for managing current working topics, and a
            <strong>Completed log</strong> for tracking topics which have been finished.
        </p>
        <p>
            A central feature is the <strong>Board</strong> which allows you to define stages (columns) of a workflow for visualizing and managing
